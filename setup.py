...
with open("src/weather/__init__.py", encoding='utf-8') as file_handler:
...
setup(
    ...
    name=package_name,
    version=version,
    description="Weather is a modern terminal application for reading weather forecasts by harvesting the OpenWeather API and features rich configuration options.",
    long_description=long_description,
    long_description_content_type='text/markdown',
    url="https://github.com/hentai-chan/weather",
    project_urls={
    ...
    keywords="cli, terminal, utils, weather",
)
